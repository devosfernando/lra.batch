# -*- coding: utf-8 -*-
# pip install webdriver-manager, selenium, openpyxl, gunicorn, mysql-connector-python
# gunicorn remotly:AppBatch 
import os
import json
import openpyxl   
import shutil
...
import src.lib.sincronizar as sincronizar
...
# Importamos el sincronizzador de la tabla history
import src.lib.googleDrive as googleDrive
